...
<ChildComponent msg="Hello Child" msg2="Hello 3"/>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>Store Types:</p>
      <!-- Activity 10: Iterate through the storeTypes object and display the store type and the number of stores that use that type. -->
      ...
      <p>We operate in:
        <ul>
          <li v-for="country in bookstores.countries">{{ country }}</li>
        </ul>
      </p>
      <p>Our #1 seller:</p>
      <ul>
        <li v-for="book in bookstores.topSellers">{{ book }}</li>
